...
echo
echo "Copying T1-weighted Skull-Stripped Images."
echo
...
for folders in $srcDir/$fPrefix* ; do
	...
	inputImageFolder=$srcDir/$folderName/04_SkullStripping_ROBEX
	...
	fileName=$(ls $inputImageFolder/*T1w*Brain*)
...
echo
echo "Completed Copying T1-weighted Skull-Stripped Images."
echo

# Unzip Compressed Image Files
gunzip $tempImageLabelingFolder/*
