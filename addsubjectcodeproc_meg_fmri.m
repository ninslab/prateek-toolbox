function addsubjectcodeproc_meg_fmri(hObject, eventdata, h)
...
megdatafile = getappdata(0,'filepathfmrimeg');disp(megdatafile);
meg_mri_filedata = getappdata(0, 'filepathmegmri');disp(meg_mri_filedata);
...
file_megdata = strcat(file_dir, '/MEG');
file_meg_mri_data = strcat(file_dir, '/MRI/MEG');
file_meg_mri_dataraw = strcat(file_dir, '/MRI/Raw');
%file_mrsdata = strcat(file_dir, '/MRS/Raw');
%file_mrsmridata = strcat(file_dir, '/MRI/MRS');
%file_mrslabel = strcat(file_dir, '/MRS/', labelname);
