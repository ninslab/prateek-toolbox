...
f = cd; % added by Saurav
key3 = 'Analysis';

if any(f~=0)
  %roi_fname = maroi('filename', fullfile(p, f));
  roi_fname = maroi('filename', fullfile(f, key3)); % added by Saurav
  try
    varargout = {saveroi(o, roi_fname)};
    detailsimg = ['Mask','_roi.nii'];
    save_as_image(o, detailsimg);
  catch
