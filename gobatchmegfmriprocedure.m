function gobatchmegfmriprocedure(hObject, eventdata, h)
...
elseif getmeganalysis == 1 && checkpreprocessingval == 1 && checksubjectanalysisval == 1
    ...
    % elseif getmeganalysis == 1 && checkpreprocessingval == 1 && checksubjectanalysisval == 1 && checkgroupanalysisval == 1
    %     % MEG + fMRI Preprocessing + Subject level Analysis + Group Level
    %     % Analysis
    %     meganalysisprocedure(workingdir);
