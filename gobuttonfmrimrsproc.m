function gobuttonfmrimrsproc(hObject, eventdata, h)
...
elseif checkpreprocessingval == 1 && checksubjectanalysisval == 1 && rawmaskstatusvalue == 0 && normmaskstatusvalue == 0 && resultmaskstatusvalue == 0
    ...
    % elseif checkpreprocessingval == 1 && checksubjectanalysisval == 1 && checkgroupanalysisval == 1 && rawmaskstatusvalue == 0 && normmaskstatusvalue == 0 && resultmaskstatusvalue == 0
    %     fprintf('Pre-Processing + Subject Level Analysis + Group Level Analysis \n');
